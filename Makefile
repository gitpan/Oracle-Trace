# This Makefile is for the Oracle::Trace extension to perl.
#
...
#     ABSTRACT_FROM => q[Oracle/Trace.pm]
#     AUTHOR => q[Richard Foley <oracle.trace@rfi.net>]
#     NAME => q[Oracle::Trace]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[Oracle/Trace.pm]
...
AR_STATIC_ARGS = cr
NAME = Oracle::Trace
DISTNAME = Oracle-Trace
NAME_SYM = Oracle_Trace
VERSION = 1.06
VERSION_SYM = 1_06
XS_VERSION = 1.06
...
FULLEXT = Oracle/Trace
BASEEXT = Trace
PARENT_NAME = Oracle
DLBASE = $(BASEEXT)
VERSION_FROM = Oracle/Trace.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"1,06,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT>Perl Module for parsing Oracle Trace files</ABSTRACT>\n\t<AUTHOR>Richard Foley &lt;oracle.trace\@rfi.net&gt;</AUTHOR>\n}" > $(DISTNAME).ppd
